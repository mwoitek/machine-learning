...
"""
Implementation of the GRADIENT DESCENT algorithm. This version of the algorithm uses a CONSTANT STEP SIZE.
"""
...
def main():
    ...
    if gam <= 0:
        exit("The step size has to be strictly positive.")
    elif prec <= 0:
    ...
    x, i = gdn.grad_desc_const_step(gam, prec, max_iter)
