...
#
#
# Function that gives us a numerical estimate for the gradient of the cost
# function. We do so by using "finite differences". This function returns the
# vector numgrad. numgrad(i) stores an approximation for the partial derivative
# of J with respect to theta(i) (evaluated at theta). This file isn't just a
